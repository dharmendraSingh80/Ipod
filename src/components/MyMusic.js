        ...
        return(
            <div style={styles.myMusicContainer}>
                ...
                <div style={styles.info}>
                    <img style={styles.image} src="https://i1.sndcdn.com/artworks-qlkwriFkbXOo-0-t500x500.jpg"></img>
                    <div style={styles.subInfo}>
                        <h4 style={{marginBottom:'0.5rem'}}>Behind Blue Eyes</h4>
                        <p style={{marginBottom:'0'}}>Legion</p>
                        <p>Jeff Russo</p>
                    </div>
