...
import sound from "../assets/music/Legion.mp3";
...
class Ipod extends React.Component {
  ...
  // on rotatation of wheel we can select the activeItem
  rotateWheel = () => {
  ...
  //this method helps me to enter inside ActiveItem by clicking center button
  changePage = () => {
  ...
  // this method helps me to get out from the diffent activePages to home by clicking menu button
  ...
  //it is the method helps me to toggle the value like pause to play or play to pause
  toggle = () => {
  ...
  render() {
    //basic ui of my ipod has written over here
    return (
        ...
        >
          <div style={styles.buttonContainer}>
            <div style={styles.menuButton}>
              <p onClick={this.changePageToHomeScreen} style={styles.image}>
                MENU
              </p>
            </div>
          </div>
...
// we are using inline css for this component
const styles = {
  ipodContainer: {
    height: "33rem",
    width: "20rem",
    backgroundImage: "radial-gradient(white, #4d4f50)",
    margin: "4rem auto",
    display: "flex",
    flexDirection: "row",
    flexWrap: "wrap",
